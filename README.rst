...
For each pattern we try to give these points::
    ...
    Conceptual diagram of the design pattern
    Examples
        principle
        example of bad design (with source)
        example improved with pattern (with source)
    Tips
    Warnings
...
You can create a new Issue with an appropriate name.
